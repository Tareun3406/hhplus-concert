...
class PaymentEventListener(
    ...
    @KafkaListener(
        topics = ["payment.pay.request"],
        groupId = "payment.pay.request.consumer",
        properties = [
            "${JsonDeserializer.USE_TYPE_INFO_HEADERS}:false",
            "${JsonDeserializer.VALUE_DEFAULT_TYPE}:kr.tareun.concert.application.payment.model.OrderPayEvent"
        ])
