...
class ReservationRepositoryImpl (
    ...
    override fun incrementCacheReservationCount(concert: Concert) {
        reservationRedisCacheRepository.increaseReservationCountToConcert(concert)
    }

    override fun getReservationRankedConcert(rankingSize: Int): List<Concert> {
        return reservationRedisCacheRepository.getRankedConcertList(rankingSize)
    }
}